...
- [build from source with Docker](https://raw.githubusercontent.com/newsboat/newsboat/master/doc/docker.md). Note that the resulting binary
...
See [CONTRIBUTING.md](https://raw.githubusercontent.com/newsboat/newsboat/master/CONTRIBUTING.md)
