...
[Doc](https://raw.githubusercontent.com/gokcehan/lf/master/doc.md)
...
- A reasonable set of other features (see the [documentation](https://raw.githubusercontent.com/gokcehan/lf/master/doc.md))
...
Run `lf -help` to see [command line options](https://raw.githubusercontent.com/gokcehan/lf/master/doc.md#options).

Run `lf -doc` to see the [documentation](https://raw.githubusercontent.com/gokcehan/lf/master/doc.md).

See [etc](https://raw.githubusercontent.com/gokcehan/lf/master/etc) directory to integrate `lf` to your shell and/or editor.
...
See [contributing](https://raw.githubusercontent.com/gokcehan/lf/master/CONTRIBUTING.md) for guidelines.
