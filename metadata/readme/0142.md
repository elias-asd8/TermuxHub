...
Note that the [Manpage syntax](https://raw.githubusercontent.com/sharkdp/bat/master/assets/syntaxes/02_Extra/Manpage.sublime-syntax) is developed in this repository and still needs some work.
...
take a look at the ["Using `bat` on Windows"](https://raw.githubusercontent.com/sharkdp/bat/master/#using-bat-on-windows) section.
...
[configuration file](https://raw.githubusercontent.com/sharkdp/bat/master/#configuration-file).
...
['Adding new themes' section below](https://raw.githubusercontent.com/sharkdp/bat/master/#adding-new-themes).
...
4. If you think that a specific syntax should be included in `bat` by default, please
   ...
   instructions [here](https://raw.githubusercontent.com/sharkdp/bat/master/doc/assets.md): [Open Syntax Request](https://github.com/sharkdp/bat/issues/new?labels=syntax-request&template=syntax_request.md).
...
**Note:** You probably want to use this option as [an entry in `bat`'s configuration file](https://raw.githubusercontent.com/sharkdp/bat/master/#configuration-file)
...
Instead of using environment variables, you can also use `bat`'s [configuration file](https://raw.githubusercontent.com/sharkdp/bat/master/#configuration-file) to configure the pager (`--pager` option).
...
your `PATH` or [define an environment variable](https://raw.githubusercontent.com/sharkdp/bat/master/#using-a-different-pager). The [Chocolatey package](https://raw.githubusercontent.com/sharkdp/bat/master/#on-windows) installs `less` automatically.
...
or use one of the basic [8-bit themes](https://raw.githubusercontent.com/sharkdp/bat/master/#8-bit-themes) designed for a restricted set of colors.
...
Take a look at the [`CONTRIBUTING.md`](https://raw.githubusercontent.com/sharkdp/bat/master/CONTRIBUTING.md) guide.
...
See [`SECURITY.md`](https://raw.githubusercontent.com/sharkdp/bat/master/SECURITY.md).
...
[this document](https://raw.githubusercontent.com/sharkdp/bat/master/doc/alternatives.md) for a comparison.
...
See the [LICENSE-APACHE](https://raw.githubusercontent.com/sharkdp/bat/master/LICENSE-APACHE) and [LICENSE-MIT](https://raw.githubusercontent.com/sharkdp/bat/master/LICENSE-MIT) files for license details.
